...
\begin{enumerate}
  ...
  \item For the field contributions of each dipole the current distribution is assumed sinusoidal with variations based on $I_0 e^{-j\beta l}$
\end{enumerate} \\
...
\section*{Conclusion}
There was a discrepancy between calculations and simulations the directivity of:
$$
4.4~\text{dBi} - 3.65~\text{dBi} = 0.75~\text{dBi}
$$

\noindent The radiation pattern can be seen by opening \texttt{Meander\_Line\_Radiation\_Pattern\_3D.html} or by running the \texttt{Antenna\_sim.ipynb}
